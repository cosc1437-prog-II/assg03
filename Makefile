...
${OBJ_DIR}/assg03-library.o: ${SRC_DIR}/assg03-library.cpp ${INC_DIR}/assg03-library.hpp
${OBJ_DIR}/${PROJECT_NAME}-tests.o: ${SRC_DIR}/${PROJECT_NAME}-tests.cpp ${INC_DIR}/assg03-library.hpp
